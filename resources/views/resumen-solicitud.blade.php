...
<body>
    ...
    <!--TABLA SOLICITUD ADOPCION-->

    @if($registros->count() > 0)
        <div class="table-responsive p-3 mx-auto w-50">
            <table class="table table-bordered">
                ...
                <tbody>
                    @foreach($registros as $registro)
                        <tr>
                            <td>{{ $registro->id_solicitud_adopcion }}</td>
                            <td>{{ $registro->descripcion }}</td>
                            <td>
                                <a href="{{ route('descargar-pdf', $registro->id_solicitud_adopcion) }}" class="btn btn-primary">Descargar PDF</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
    ...
    @else
        <p>No hay registros de solicitud de adopción.</p>
    @endif
    <!-- FIN DE LA TABLA -->
